...
#define bindir "..\..\Bin\"
#define grepwindir "..\..\grepWin\portables\"
#if Arch == "x86"
  #define grepwinexe "grepWin-x86_portable.exe"
#else
  #define grepwinexe "grepWin-x64_portable.exe"
#endif
#ifndef RLSdir
...
#ifnexist grepwindir + grepwinexe
  #pragma error "grepWin portable executable not found: "+grepwinexe
#endif
...
#define app_publisher "JulienMaille"
#define app_version GetVersionNumbersString(bindir + RLSdir + "\Notepad3.exe")
#define app_copyright "Copyright © 2008-" + GetDateTimeString("yyyy", "", "") + " JulienMaille"
...
AppPublisherURL=https://github.com/JulienMaille/Notepad3
AppSupportURL=https://github.com/JulienMaille/Notepad3/wiki
AppUpdatesURL=https://github.com/JulienMaille/Notepad3/releases
AppContact=https://github.com/JulienMaille/Notepad3
AppCopyright={#app_copyright}
VersionInfoVersion={#app_version}
VersionInfoDescription={#app_name} ({#Arch}){#VRSN} Installer
VersionInfoProductName=Notepad3
...
Source: "{#grepwindir}{#grepwinexe}"; DestDir: "{app}\grepWin"; Flags: ignoreversion
Source: "{#grepwindir}LICENSE.txt"; DestDir: "{app}\grepWin"; Flags: ignoreversion
Source: "..\..\grepWin\translations\*.lang"; DestDir: "{app}\grepWin"; Flags: ignoreversion
...
Filename: "https://github.com/JulienMaille/Notepad3/releases"; Flags: nowait postinstall shellexec skipifsilent unchecked; Description: "{cm:tsk_LaunchWelcomePage}"
...
Type: files; Name: "{app}\grepWin\grepwin.ini"
